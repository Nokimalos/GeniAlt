...
import { postRegisterFreelancer } from '../server/postRoutes';
import { Freelancer } from '../models/types';

const RegisterFreelancer = () => {
    console.log('RegisterFreelancer');
        ...
        <Box h='100vh' py='60px' bg='#fcfcf7' >
            <VStack>
                <Box p='70px' rounded='2xl' minH='500px' w='60%' border='2px' borderColor='grey' >
                    ...
                    <Select onChange={e => setSkill(e.target.value)} my='6px' rounded='md' border='2px' borderColor='grey' placeholder='Main skill' _hover={{
                        transitionDuration: '500ms',
                        borderColor: '#229ef1'
                    }} >
